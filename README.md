...
How the rewrite actually works (scratch-card trick, conflict guard,
per-machine cache) is in [Architecture](#architecture--how-it-works) below.
...
See [`CHANGELOG.md`](./CHANGELOG.md). Versions follow [SemVer](https://semver.org).
